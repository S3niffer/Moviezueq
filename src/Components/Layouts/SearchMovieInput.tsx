    ...
    return (
        <Portal>
            <div className='fixed z-40 top-[var(--navbar-height)] w-screen'>
                <div className='container rtl flex justify-between text-added-white'>
                    <div className='w-1/5'></div>
                    <div className='w-3/6 pr-1'>
                        <div className='rounded-sm border md:border-4 480:border-2 border-added-charcoal backdrop-blur-sm p-0.5 max-h-24  480:max-h-32 sm:max-h-40 md:max-h-48 lg:max-h-56 overflow-y-auto ltr 480:p-1 sm:p-1.5 md:p-2 lg:p-2.5'>
                            <div className='rtl flex flex-col gap-1 480:gap-1.5 sm:gap-2 md:gap-2.5 lg:gap-3'>{children}</div>
                        </div>
                    </div>
